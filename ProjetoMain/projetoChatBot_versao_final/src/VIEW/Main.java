...
public class Main extends javax.swing.JFrame {
        ...
        hilo = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    pergunta=texto.getText();
                    resposta=(new BuscaDatos().translate(texto.getText()));

                    pantalla.append("Você: "+texto.getText() +"\n");
                    texto.setText(""); //apresenta no texto do chat boot
                    animacionEscribir(resposta);
                    int probabilidad=mitadProbabilidad();

                   
                    if (resposta.equalsIgnoreCase("Desculpa, não entendi como posso ajudar?")){
                        pantalla.append("Wall-e: Poderia me ensinar a responder essa pergunta?  '"+pergunta+"' \n");
                        String respuestUsuario= JOptionPane.showInputDialog("Deseja ensinar? (Sim ou Não)");
                        if (respuestUsuario.equalsIgnoreCase("sim")){
                            String respuestUsuarioPregunta= JOptionPane.showInputDialog("O que devo responder a: '"+pergunta+"'");
                            Leer aprender =new Leer();
                            String novapalavra=aprender.preguntanueva(pergunta,respuestUsuarioPregunta);
    ...
    public void fijarTexto(){
         pantalla.append("Maquina: "+ resposta+"\n");
        texto.setText("");
    }
